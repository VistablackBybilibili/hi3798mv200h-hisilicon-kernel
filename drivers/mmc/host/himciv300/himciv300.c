...
static u32 himciv300_host_is_emmc(struct himciv300_host *host)
{
...
static void himciv300_control_cclk(struct himciv300_host *host, u32 enable)
{
	...
	//TODO: low power mode disable
		...
		if (himciv300_host_is_emmc(host))
					      ...
					      struct mmc_ios *ios)
{
	...
	/* only support sd/sdio */
	regval = himciv300_host_is_emmc(host);
	if(regval)
		return 0;
	/*
