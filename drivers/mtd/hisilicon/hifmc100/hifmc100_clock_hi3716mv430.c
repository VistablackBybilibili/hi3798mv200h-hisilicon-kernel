...
struct spinand_chip_xfer hifmc100_spinand_chip_xfer[] = {
	...
	{"TC58CVG0S3HRAIx", {0x98, 0xc2}, 2, 1, _75MHz},
	{"MX35LF1GE4AB",  {0xC2, 0x12}, 2, 4, _75MHz},
...
struct spinor_chip_xfer hifmc100_spinor_chip_xfer[] = {
	...
	{ "S25FL128S", {0x01, 0x20, 0x18, 0x4d, 0x00, 0x80}, 6,
		.read = SPIFLASH_XFER(SPINOR_OP_READ_DUAL, 1, 0, 80),
		.write =  SPIFLASH_XFER(SPINOR_OP_PP, 0, 512, 80),
		.erase =  SPIFLASH_XFER(SPINOR_OP_SE_256K, 0, SZ_256K, 80),},
